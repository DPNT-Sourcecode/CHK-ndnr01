...
def _total_number_items_applicable_for_group_discounts(number_of_items_in_inventory:dict, price_of_items: dict):
    ...
    for item in list_of_items_for_group_discount:
        total_number_of_items_in_group_discount +=total_number_of_items_in_group_discount+number_of_items_in_inventory.get(item, 0)
        list_of_prices_of_group_discount_items.append()